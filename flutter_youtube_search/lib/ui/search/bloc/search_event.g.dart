...
class _$SearchInitiated extends SearchInitiated {
  ...
  factory _$SearchInitiated([void Function(SearchInitiatedBuilder)? updates]) =>
      (new SearchInitiatedBuilder()..update(updates))._build();

  _$SearchInitiated._({required this.query}) : super._() {
    BuiltValueNullFieldError.checkNotNull(query, r'SearchInitiated', 'query');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SearchInitiated')
          ..add('query', query))
        .toString();
  }
}
...
class SearchInitiatedBuilder
  ...
  @override
  SearchInitiated build() => _build();

  _$SearchInitiated _build() {
    final _$result = _$v ??
        new _$SearchInitiated._(
            query: BuiltValueNullFieldError.checkNotNull(
                query, r'SearchInitiated', 'query'));
    replace(_$result);
    return _$result;
  }
}
