...
class _$SearchSnippet extends SearchSnippet {
  ...
  factory _$SearchSnippet([void Function(SearchSnippetBuilder)? updates]) =>
      (new SearchSnippetBuilder()..update(updates))._build();
  ...
  _$SearchSnippet._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        publishedAt, r'SearchSnippet', 'publishedAt');
    BuiltValueNullFieldError.checkNotNull(
        channelId, r'SearchSnippet', 'channelId');
    BuiltValueNullFieldError.checkNotNull(title, r'SearchSnippet', 'title');
    BuiltValueNullFieldError.checkNotNull(
        description, r'SearchSnippet', 'description');
    BuiltValueNullFieldError.checkNotNull(
        thumbnails, r'SearchSnippet', 'thumbnails');
    BuiltValueNullFieldError.checkNotNull(
        channelTitle, r'SearchSnippet', 'channelTitle');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SearchSnippet')
...
class SearchSnippetBuilder
  ...
  @override
  SearchSnippet build() => _build();

  _$SearchSnippet _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SearchSnippet', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
