...
class _$SearchItem extends SearchItem {
  ...
  _$SearchItem._({required this.id, required this.snippet}) : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'SearchItem', 'id');
    BuiltValueNullFieldError.checkNotNull(snippet, r'SearchItem', 'snippet');
  }
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SearchItem', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
